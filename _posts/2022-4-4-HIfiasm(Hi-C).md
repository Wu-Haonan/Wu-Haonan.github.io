...
令${ U_st }$来表示杂合关系的unitigs ${ s,t }$之间的<i>trans</i> read overlap的数目. 这可以用来衡量两个unitigs的相似度. （在测序深度一定的前提下，杂合区段的unitigs之间<i>trans</i> overlap越少，二者越相似）. 对于每个杂合unitigs ${ t }$，变量${ \delta_t \in \left\{1,-1\right\} }$
