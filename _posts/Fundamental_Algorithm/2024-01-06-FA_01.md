...
**Proof.** Because $(a/d -1) < \lfloor a/d \rfloor \leq a /d$, we have $0 \leq a - d \lfloor a/d \rfloor < d$. Let $r= a − d \lfloor a/d \rfloor$ and $q = \lfloor a/d \rfloor$, we know $a = qd + r$ such that $ 0\leq r < d$. We know such $q,r$ are unique, so they are quotient and reminder. $\square$
</details>
...
In fact, this theorem is more profound than we thought, we will talked it later after give a corollary. 
