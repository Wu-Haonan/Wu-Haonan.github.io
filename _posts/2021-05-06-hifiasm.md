...
刚才我们简单介绍了Trio binning的原理，因为其根据k-mers的父源、母源来对子代long-reads进行分类，其实文章用了Angus and Brahman两个品种 的牛（安格斯和婆罗门）做了实杂交实验，再进行测序，但是对于亲缘关系更近的人类，trio binning的contigs长度就大大减小了，因为噪声更多，分辨read属于父母哪一方更困难。
