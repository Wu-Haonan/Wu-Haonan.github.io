...
为什么使用HiFi-read，其实也很好理解，因为同源染色体本身的差距就很小，根据这篇文章所讲，人类的杂合子的差距在0.1%以内，如果read本身误差很大，那么对于回复更精确的同源序列就更是天方夜谭了。PS：个人认为，可能正是HiFi-read准确度、长度都大大提高，所以才使得单倍型的组装进一步发展，使得染色体规模的单倍型组装成为可能（确实最近这方面的文章在nature子刊上发表了很多）.
