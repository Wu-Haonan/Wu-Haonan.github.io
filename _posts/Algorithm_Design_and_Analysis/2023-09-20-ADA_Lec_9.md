...
<p align="center">
    <img src="/post_image/Algorithm_design_Analysis/3-coloring-variables.png" width="60%">
</p>
...
/3-coloring-clause.png" width="80%">
</p>

* <b>Observation 2</b> First, in the green box, we link the literals to its negation. By <b>Observation 1</b>, we know the literals can only be ${ T }$ or ${ F }$, so the inputs of the gadget will be consistent to the assignment in the nodes generated in step 1. 

* We will find the structure in the 