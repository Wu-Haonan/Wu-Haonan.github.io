---
layout: article
title: Lecture 2:Piecewise linear convex objective funvctions
...
<b>Definition: <font color=red>A function ${ f: \mathbb{R}^n \rightarrow \mathbb{R} }$ is called <u><b>convex</b></u> if for every pair of points ${ \bar{x}, \bar{y} \in \mathbb{R}^n }$ and every ${ \lambda \in [0,1] }$, we have 
