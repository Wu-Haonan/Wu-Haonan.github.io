...
Take $\bar{x} = \bar{0}, \bar{y} = \bar{e_i}$ and replace $\lambda$ as $t_i\in [0,1]$ in equation (30), we get
...
Take $\bar{x} = \bar{0}, \bar{y} = t_i \cdot \bar{e_i}$ and replace $\lambda \in (0,1]$ as $\frac{1}{t_i}, t_i\in [1,+\infty)$ in equation (30), we get
...
Take $\bar{x} = -t_i\cdot \bar{e_i}, \bar{y} = t_i \cdot \bar{e_i}, t_i \in \mathbb{R} $ and fix $\lambda = \frac{1}{2}$ in equation (30), we get
...
$\forall t_i \in (-\infty,0]$, that is $-t_i \in [0,+\infty)$, take $-t_i$ in formula (34), we have
...
Combine formula (34) and (37), we have 
...
Take $\bar{x} = 2 \cdot \sum_{i=1}^{n-1} t_i \bar{e_i}, \bar{y} = 2\cdot t_n\bar{e_n}$ and fix $\lambda = \frac{1}{2}$ in equation (30), we have
